 ...
 */
function fedexercise_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['fedexercise_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('fedexercise_theme sample setting'),
  '#default_value' => theme_get_setting('fedexercise_theme_example'),
